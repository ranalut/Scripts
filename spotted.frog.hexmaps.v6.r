...
startTime <- Sys.time()
# theCentroids <- read.dbf('F:/PNWCCVA_Data2/HexSim/Workspaces/sage_grouse_v2/Spatial Data/albers_centroids_1km_wgs84.dbf', as.is=TRUE)
# theCentroids <- read.csv('F:/PNWCCVA_Data2/HexSim/Workspaces/centroids84.txt', header=TRUE)
