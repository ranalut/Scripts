...
print(AIC(ly_01)) # Poisson 164151.8 ******
...
print(AIC(ly_02)) # Poisson 164365.2
...
print(AIC(ly_03)) # Poisson 181021.5
...
print(AIC(ly_04)) # Poisson  180867.7
...
print(AIC(ly_05)) # Poisson 197523.9
...
print(AIC(ly_01a)) # Poisson 138753.8 ******
plot(ly_01a)
qqnorm(resid(ly_01a), main="Q-Q plot for residuals")
qqline(resid(ly_01a),col='red')
print(summary(ly_01a)) # Adjusted R^2 = 98.7%, Deviance explained 98.2%
...
print(AIC(ly_01b)) # Poisson 157305.9
