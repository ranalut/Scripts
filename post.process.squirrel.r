...
# for (map in 1:3) { source('post.process.squirrel.r') }
...
workspace <- 'l:/space_lawler/shared/wilsey/postdoc/hexsim/workspaces/town_squirrel_v1/'
scenario <- 'squirrel.11.hab.v2.'
...
if (run.post.proc=='y')
{
	post.processing.maps(
			...
			out.name='townsends_squirrel_complex'
			)
}
