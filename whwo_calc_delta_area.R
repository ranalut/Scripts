...
path <- c('white_headed_woodpecker/white_headed_woodpecker_huc_') 
dens_thresh <- c(0.01)
...
png("D:/Box Sync/PNWCCVA/MS_Woodpecker/Results/pd_acreages3.png",height=500)
  plot(p)
dev.off()
write.csv(bar_table3,"D:/Box Sync/PNWCCVA/MS_Woodpecker/Results/delta_acreages3.csv")
stop('cbw')
