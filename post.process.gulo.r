...
# for (map in 1:3) { source('post.process.gulo.r') }
...
scenario <- 'gulo.023.a2.'
workspace <- 'h:/hexsim/workspaces/wolverine_v1/'
theGCMs <- c('ccsm3','cgcm3','giss-er','miroc','hadcm3')
model.types <- list(c('','.biomes','.swe'),c('full','biomes','swe'))
reps <- 5
