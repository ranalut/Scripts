...
# For the Nutcracker and Woodpecker
build.paths2 <- function(var.index, theGCM)
{  
  z <- var.index
  theFolders.a2 <- c('deficit_ann_a2_v1','fire_frac_a2','mtco_a2','mtwa_a2')
  theFolders.cru <- c('deficit_ann_v1','afirefrac','mtco','mtwa')
  
  file.name.a2.pre <- c('','wna30sec_a2_','wna30sec_a2_','wna30sec_a2_')
  file.name.a2.suf <- c('_deficit_ann_','_lpj_afirefrac_','_mtco_','_mtwa_')
  file.name.cru <- c('deficit_ann_','wna30sec_cru_ts2.1_lpj_afirefrac_','wna30sec_cru_ts_2.10_mtco_','wna30sec_cru_ts_2.10_mtwa_')
