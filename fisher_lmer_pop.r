...
# sink('../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_lmer_aic.txt',append = TRUE)
# cat('AIC','call','\n',sep='\t')
...
write.csv(fixef(mod),"../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_coef.csv")
...
write.csv(fe,"../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_coef_ci95.csv")
fe <- fe[-1,]
...
# stop('cbw')
write.csv(conf_int,"../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_95_ci_n1000.csv")
...
ggsave("../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_95_ci_n1000.png",width=7,height=5)
...
png("../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_effects.png", width = 960, height = 480)
plot(effect(c('year','gcm'),mod=mod))
dev.off()

png("../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_effects2.png", width = 960, height = 480)
plot(effect(c('sens'),mod=mod))
dev.off()
...
write.csv(test,"../Box Sync/PNWCCVA/MS_MesoCarnivores/Results/fisher_log_lmer_test_interaction.csv")
